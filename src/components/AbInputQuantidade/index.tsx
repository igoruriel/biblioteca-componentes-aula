...
const LabelEstilizada = styled.label`
    ...
    margin-bottom: 8px;
`
export interface PropsAbInputQuantidade {
    onChange: (value: number) => void
}

export const AbInputQuantidade = ({ onChange }: PropsAbInputQuantidade) => {
    ...
    return (
        <ContainerEstilizado>
            ...
            <FlexContainerEstilizado>
                <BotaoEstilizado onClick={() => setValue(prev=> prev > 0 ? prev-1 : prev)} >-</BotaoEstilizado>
